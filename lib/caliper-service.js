...
function CaliperService(id, options, getToken, storageService) {
	...
	function restartQuiz(id, quiz) {
		caliperQuiz(Caliper.Actions.AssessmentActions.RESTARTED, null, null, null, "restart quiz");
	}

	function pauseQuiz(id, quiz) {
		caliperQuiz(Caliper.Actions.AssessmentActions.PAUSED, null, null, null, "pause quiz");
	}
