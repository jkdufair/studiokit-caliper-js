...
function CaliperService(options, asyncLoadCallback) {
	...
	function loadSavedData() {
		return Q.all([
			...
			authToken = values[0] || null;
			person = values[1] || null;
			session = values[2] || null;
			sessionExtensions = values[3] || null;
			lastKeepAliveDate = values[4] || null;
			lastActivityDate = values[5] || values[6] || null;
		})
	}
